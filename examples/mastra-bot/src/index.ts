 ...
 *
 * This and the LangGraph example share no DoubleOh-specific code beyond the AG-UI protocol. Tools
...
const bot = new Agent({
  name: "DoubleOh Mastra coworker",
  instructions:
    "You are a Bot running on Mastra inside DoubleOh. You have a real web browser available through " +
 ...
 * what puts every call through DoubleOh's policy gateway instead of this process.
 */
