 ...
 *
 * This is a real LangGraph `StateGraph` with its own model client and tool loop. DoubleOh knows it
...
function toLangChainMessages(input: RunAgentInput): BaseMessage[] {
  const messages: BaseMessage[] = [
    new SystemMessage(
      "You are a Bot running on LangGraph inside DoubleOh. You have a real web browser available " +
